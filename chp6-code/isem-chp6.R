...
f62 <- ggplot(d2, aes(x = x, y = y)) +
  ...
  annotate("text", x = -4.2, y = 0.006, label = "none", family = "Times New Roman") +
  annotate("text", x = -2.4, y = 0.006, label = "a little", family = "Times New Roman") +
  annotate("text", x =  0.5, y = 0.006, label = "some", family = "Times New Roman") +
  annotate("text", x =  3.0, y = 0.006, label = "most", family = "Times New Roman") +
  annotate("text", x =  4.6, y = 0.006, label = "all", family = "Times New Roman") +
...
cor(d3)
  ...
  f64a <- prfig(nrv_tau[1], nrv_tau[2], nrv_tau[3], nrv_tau[4], nrv_lambda) +
    annotate("text", x = -1.5, y = 0.68, label = "N", size = 4, family = "Times New Roman") +
    annotate("text", x = -1.5, y = 0.20, label = "L", size = 4, family = "Times New Roman") +
    annotate("text", x =  0.5, y = 0.35, label = "S", size = 4, family = "Times New Roman") +
    annotate("text", x =  2.0, y = 0.27, label = "M", size = 4, family = "Times New Roman") +
    annotate("text", x =  2.0, y = 0.55, label = "A", size = 4, family = "Times New Roman") +
    ggtitle("Panel A: Nervous")
  
  f64b <- prfig(dep_tau[1], dep_tau[2], dep_tau[3], dep_tau[4], dep_lambda) +
    annotate("text", x = -1.5, y = 0.93, label = "N", size = 4, family = "Times New Roman") +
    annotate("text", x = -1.5, y = 0.07, label = "L", size = 4, family = "Times New Roman") +
    annotate("text", x =  1.0, y = 0.28, label = "S", size = 4, family = "Times New Roman") +
    annotate("text", x =  2.0, y = 0.22, label = "M", size = 4, family = "Times New Roman") +
    annotate("text", x =  2.0, y = 0.55, label = "A", size = 4, family = "Times New Roman") +
